...
<html>
    ...
    <nav class="navbar navbar-default">
      <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="active"><a href="/light/create">Grow light</a></li>
    ...
    <body>
        <center>
            ...
            <h3>LED Control : <span id="status" class="connect">Connect...</span>NETPIE2020</h3>
            <p id="status-led">...</p>
            <button id="led-on" disabled>ON</button> <button id="led-off" disabled>OFF</button>
			      <button id="timer" disabled>TIMER</button> <button id="ldr" disabled>LDR</button>
        </center> 


        <div class="container">
            <h2 class="mt-5">ตั้งเวลาGrow light</h2>
        ...
        <form method="post" action="{{url('light')}}">
          {{csrf_field()}}
          เวลาเปิด<br>
          ...
          {{-- <button type="button" class="btn btn-default" data-dismiss="modal">Close</button> --}}
            ...
            <table class="table">
              <thead class="thread-dark">
                  ...
                  <td>
                        <form action="{{url('light',[$item->id])}}" method="post">
...
$(document).ready(function(e) {
    ...
    client.onMessageArrived = function(message) {
        if (message.payloadString == "LEDON" || message.payloadString == "LEDOFF" || message.payloadString == "TIMER" || message.payloadString == "LDR") 
		{
			...
			$("#ldr").attr("disabled", (message.payloadString == "LDR" ? true : false));
        }
    }
	...
	$("#timer").click(function(e) {
        mqttSend("@msg/led", "TIMER");
        document.getElementById("status-led").innerHTML = "MODE TIMER";
    });
	$("#ldr").click(function(e) {
        mqttSend("@msg/led", "LDR");
        document.getElementById("status-led").innerHTML = "MODE LDR";
    });
});
